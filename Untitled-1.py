...
from translate import convertMorseToText
#import time
...
predictor = dlib.shape_predictor("E:\Chrome Downloads\shape_predictor_68_face_landmarks (2).dat")
...
word_pause_frames = 40 # ajust this for detecting word seperation
